...
public class Materia implements Parcelable {
    ...
    public String getU_materia(){return  u_materia;}

    public void  setU_materia(String u_materia){this.u_materia=u_materia;}
